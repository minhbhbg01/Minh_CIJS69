...
class Register {
    ...
    constructor() {
        ...
        this.$titleRegisterEL = document.createElement("div");
        this.$titleRegisterEL.textContent = "Register";
        this.$titleRegisterEL.setAttribute("class", "text-center font-medium text-2xl");
        ...
        this.$goToLoginPage = document.createElement("div");
        this.$goToLoginPage.textContent = "Go to login";
        this.$goToLoginPage.setAttribute("class", "text-white font-bold mt-3 w-24 bg-red-400 rounded-md hover:bg-blue-200 cursor-pointer");
    ...
    render(container) {
        this.$formEl.appendChild(this.$titleRegisterEL);
